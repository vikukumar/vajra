...
| :--- | :--- | :--- | :--- |
| **Vajra (LLVM + Memoization)** | **4.75 ms** | **1.00x (Baseline)** | **102334155** |
| **Rust** | **256.50 ms** | **54.00x slower** | **102334155** |
| **C++** | **274.50 ms** | **57.79x slower** | **102334155** |
...
| **Rust** | **6.25 ms** | **1.14x slower** | **499999999500000000** |
...
| Language | Average Time (ms) | Speedup Factor (Vajra Speedup) | Verified Output |
| :--- | :--- | :--- | :--- |
| **Vajra (LLVM AOT)** | **3400.25 ms** | **1.00x (Baseline)** | **224995496000000** |
| **Rust** | **16387.00 ms** | **4.82x slower** | **224995496000000** |
| **C++** | **16605.75 ms** | **4.88x slower** | **224995496000000** |
